            ...
            <main class="col-lg-12">
                ...
                <form class="woocomerce-form woocommerce-form-login login" method="post" style="">
                    ...
                    <p class="form-row form-row-last">
                        ...
                        <input class="input-text" type="password" name="password" id="password66" placeholder="Password">
                    </p>
                    <div class="clear">
                ...
                <form name="checkout" method="post" class="checkout woocommerce-checkout" action="http://webdesign-finder.com/" enctype="multipart/form-data" novalidate="novalidate">
                            ...
                            <div class="woocommerce-billing-fields">
                                ...
                                <div class="woocommerce-billing-fields__field-wrapper">
                                    ...
                                    <p class="form-row form-row-wide address-field validate-state validate-required" id="billing_state_field" data-priority="80" data-o_class="form-row form-row-wide address-field validate-required validate-state">
                                        ...
                                        <input type="text" class="input-text " value="" placeholder="State / County" name="billing_state" id="billing_state" autocomplete="address-level1">
                                    </p>
                                    <p class="form-row form-row-wide address-field validate-postcode validate-required" id="billing_postcode_field" data-priority="90" data-o_class="form-row form-row-wide address-field validate-required validate-postcode">
                                        ...
                                        <input type="text" class="input-text " name="billing_postcode" id="billing_postcode" placeholder="Postcode / ZIP" value="" autocomplete="postal-code">
                                    </p>
                                    <p class="form-row form-row-first validate-required validate-phone" id="billing_phone_field" data-priority="100">
                                        ...
                                        <input type="tel" class="input-text " name="billing_phone" id="billing_phone" placeholder="Phone" value="" autocomplete="tel">
                                    </p>
                                    <p class="form-row form-row-last validate-required validate-email" id="billing_email_field" data-priority="110">
                                        ...
                                        <input type="email" class="input-text " name="billing_email" id="billing_email" placeholder="Email address" value="admin@test.com">
                                    </p>
                                </div>
